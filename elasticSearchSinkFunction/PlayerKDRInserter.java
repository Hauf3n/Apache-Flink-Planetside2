...
public class PlayerKDRInserter implements ElasticsearchSinkFunction<Tuple2<String, Double>> {
    @Override
    public void process(Tuple2<String, Double> t, RuntimeContext runtimeContext, RequestIndexer requestIndexer) {
        Map<String,String> json = new HashMap<>();

        json.put("eventname","Player KDR");
        json.put("character_id",String.valueOf(t.f0));
