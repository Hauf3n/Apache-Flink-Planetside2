...
public class BatchMapEventLogInOut implements MapFunction<JsonNode, Tuple4<String, String, Integer, Integer>> {
    @Override
    public Tuple4<String, String, Integer, Integer> map(JsonNode payload) throws Exception {
        return new Tuple4<>( payload.get("event_name").asText(),
